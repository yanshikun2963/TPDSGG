...
def train(cfg, local_rank, distributed, logger):
    ...
    # amp removed - no mixed precision
    ...
    elif cfg.MODEL.WEIGHT and cfg.MODEL.WEIGHT != "":
        # NEW: Loading model from cfg.MODEL.WEIGHT (resume full SGG model, without optimizer)
        print(f"[init] Loading model from cfg.MODEL.WEIGHT: {cfg.MODEL.WEIGHT}")
